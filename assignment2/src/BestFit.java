...
public class BestFit extends MemoryAllocationAlgorithm {
    ...
    public int fitProcess(Process p, ArrayList<MemorySlot> currentlyUsedMemorySlots) {
        ...
        for (int i = 1; i < n; ++i) { // Sorts the array of available block sizes to use the smallest available block.
        ...
        for(int availableBlock=0; availableBlock<sortedAvailableBlockSizes.length; availableBlock++){ // Finds the smallest available block, to add the process
